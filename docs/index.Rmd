...
### Sourcing alcohol/smoking chart
```{r setup, include=FALSE}
source("../source/chart2.R")
knitr::opts_chunk$set(echo = TRUE)
```

This table tracks the correlation between smoking and alcohol abuse and breast cancer
rates. We found a strong positive correlation between these two factors, suggesting 
those who indulge in one or both of those activities have a much higher chance of 
